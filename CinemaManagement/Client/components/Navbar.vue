  ...
  <nav>
    <div class="flex justify-evenly text-[#212121] text-xl xl:text-2xl">
      ...
      <div class="flex gap-x-8 xl:gap-x-10">
        <a class="hover:font-bold cursor-pointer hover:text-red-7" @click="modal.open(SignIn)">Sign in</a>
        <a class="hover:font-bold cursor-pointer hover:text-red-7" @click="modal.open(SignUp)">Sign up</a>
      </div>
    </div>
