...
<template>
  <div class="flex my-auto p-5 shadow rounded-sm">
    <picture class="items-baseline max-w-[220px] w-full bg-cover bg-gray-300/40 mr-5">
      <img class="self-baseline" :src="image" alt="https://m.media-amazon.com/images/M/MV5BOTI4NTNhZDMtMWNkZi00MTRmLWJmZDQtMmJkMGVmZTEzODlhXkEyXkFqcGdeQXVyNjc1NTYyMjg@._V1_.jpg"/>
    </picture>
    <div class="flex flex-col justify-between w-75">
      ...
      <div class="flex justify-center mt-10">
        <button
          ...
          @click="modal.openModal(FilmDetails); store.setDetails(id, title, genre, image, description, genre, duration);">
          Details
        </button>
      </div>
